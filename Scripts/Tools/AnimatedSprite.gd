...
export(String, "BannerBlue", "BannerRed", "Lanterns","Plant","Tree","Cat","Heater","WindowTop1","WindowBottom1","WindowTop2","WindowBottom2","TV","TVCorner") var Anim setget setAnim
